    ...
    return (
      ...
      >
        <div
          ...
          dir={dir}
          className={cn(
            "flex items-center flex-wrap gap-2 p-2 rounded-lg bg-background overflow-hidden   ring-1 ring-muted  ",
            {
        ...
        >
          {value.map((item, index) => (
            <Badge
              ...
              className={cn(
                "relative px-1 rounded flex items-center gap-1 data-[active='true']:ring-2 data-[active='true']:ring-muted-foreground truncate aria-disabled:opacity-50 aria-disabled:cursor-not-allowed p-1"
              )}
            >
