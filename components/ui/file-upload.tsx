...
import { Trash2 as RemoveIcon, RotateCcw } from "lucide-react";
          ...
          toast({
            ...
            action: (
              <ToastAction
                ...
                altText="Try again"
              >
                <RotateCcw className="size-4 text-primary" /> Try Again
              </ToastAction>
            ),
          });
          return;
        ...
        if (rejectedFiles.length > 0) {
          for (let i = 0; i < rejectedFiles.length; i++) {
            if (rejectedFiles[i].errors[0]?.code === "file-too-large") {
              ...
              //   );
              toast({
                title: `*File Error. File is too large`,
            ...
            if (rejectedFiles[i].errors[0]?.message) {
              ...
              toast({
                title: `*File Error. Too many files`,
