...
const TransactionInvoice = ({
  ...
  const previewText = `Transaction Invoice`;
        ...
        <Body className=" my-auto mx-auto font-sans  p-0 ">
          <Container className="mx-auto border  mb-0 max-w-[600px]  ">
            ...
            <Section className="mb-0 px-5 ">
              <Heading className=" text-[20px] font-semibold p-0 mx-auto  my-10">
                Transaction Invoice
              </Heading>
            ...
            <Section className="  px-5 py-0 mb-0 mt-5">
              <Hr className="my-4" />
              ...
              <Row className="mb-0  p-0 mt-4" cellSpacing={0} cellPadding={0}>
                ...
                <Column
                  ...
                  className="h-[20px] w-max font-semibold text-[16px]"
                >
                  {format(booking.checkInDate, "dd MMMM yyyy")}
                </Column>
              </Row>
              {/* Check Out  */}
              <Row className="mb-0  p-0 mt-4" cellSpacing={0} cellPadding={0}>
                ...
                <Column
                  ...
                  className="h-[20px] w-max font-semibold text-[16px]"
                >
                  {format(booking.checkOutDate, "dd MMMM yyyy")}
                </Column>
              </Row>
              {/* Nights */}
              <Row className="mb-0  p-0 mt-4" cellSpacing={0} cellPadding={0}>
                ...
                <Column
                  ...
                  className="h-[20px] w-max font-semibold text-[16px]"
                >
                  {differenceInDays(booking.checkOutDate, booking.checkInDate)}
                </Column>
              </Row>
              <Hr className="my-4" />
              <Row className="mb-0  p-0 " cellSpacing={0} cellPadding={0}>
              ...
              {booking.rooms.map((room, index) => (
                <Row
                  key={index}
                  className="mb-0 p-0 mt-2 first:mt-0 font-semibold text-[16px]"
                >
                  <Column className="h-[20px] w-max ">
                  ...
                  <Column align="right" className="h-[20px] w-max ">
                    +
                    {new Intl.NumberFormat("en-US", {
                      style: "currency",
                      currency: "USD",
                ...
                >
                  ...
                  <Column align="right" className="h-[20px] w-max ">
                    ...
                    {new Intl.NumberFormat("en-US", {
                      style: "currency",
                      currency: "USD",
                    }).format(extra.cost * booking.guests)}
                  </Column>
                </Row>
              ))}
              <Hr className="my-4" />
              <Row className="mb-0  p-0 " cellSpacing={0} cellPadding={0}>
                ...
                >
                  {new Intl.NumberFormat("en-US", {
                    style: "currency",
                    currency: "USD",
                  }).format(booking.totalCost - booking.tax)}
                </Column>
              </Row>
              <Hr className="my-4" />
              {/* taxes */}
              {booking.taxRates.map((tax, index) => (
                <Row
                  key={index}
                  className="mb-0 p-0 mt-2 first:mt-0 font-semibold text-[16px]"
                >
                  ...
                  <Column align="right" className="h-[20px] w-max ">
                    ...
                    {new Intl.NumberFormat("en-US", {
                      ...
                      (booking.rooms.reduce(
                        (acc, room) =>
                          acc + room.noOfRooms * nights * room.rate,
                        0
                      ) +
                        booking.extras.reduce(
                          (acc, extra) =>
                            acc + extra.cost * nights * booking.guests,
                          0
                        )) *
                        (tax.rate / 100)
                    )}
            ...
            <Text className=" text-[12px] leading-[24px] p-5 py-4 my-0">
...
TransactionInvoice.PreviewProps = {
  user: {
