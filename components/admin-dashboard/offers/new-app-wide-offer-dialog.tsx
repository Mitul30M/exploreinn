    ...
    <Dialog>
      ...
      <DialogContent className="sm:max-w-[650px]">
        <DialogHeader>
          ...
          <DialogDescription>
            Create a new offer for all users. This offers will be available for
            all users on all listings on Exploreinn for booking purposes.
          </DialogDescription>
        </DialogHeader>
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  ...
                  <FormDescription>
                    Set the 'exploreinn-reward-points' required for the offer to
                    be redeemed.
                  </FormDescription>
                  <FormMessage />
                </FormItem>
