...
import { TransactionsDataTableToolbar } from "@/components/listing-dashoard/transactions/transaction-dashboard-table-toolbar";
...
export function AdminTransactionsDataTable<TData, TValue>({
  columns,
  data,
  className,
              ...
              table.getRowModel().rows.map((row) => (
                ...
                >
                  {row.getVisibleCells().map((cell) => (
                    <TableCell
                      key={cell.id}
                      className="text-nowrap font-medium py-2 text-center first:text-left last:text-right first:ps-4 last:pe-4 pr-6"
                    >
                      {flexRender(
