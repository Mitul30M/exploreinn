...
import { AdminDashboardUsersFloatingActionBar } from "./admin-users-table-floating-action-bar";
import { AdminDashboardUsersTableToolbar } from "./admin-users-table-toolbar";
  ...
  return (
    <div className={"relative z-0 !mx-4 w-full" + className}>
      <div className="flex items-center pb-4">
        <AdminDashboardUsersTableToolbar table={table} />
      </div>
      ...
      {table.getFilteredSelectedRowModel().rows.length > 0 && (
        <AdminDashboardUsersFloatingActionBar table={table} />
      )}
    </div>
  );
}
